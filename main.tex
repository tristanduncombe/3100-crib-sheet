...
\section{Question 1}
Some useful rules for weakest preconditions are:

\begin{tabular}{@{}ll@{}}
\verb! (A.6)! & $ A \land (A \lor B) \equiv A \equiv A \lor (A \land B)$ \\
\verb! (A.7)! & $ A \land (B \lor C) \equiv (A \land B) \lor (A \land C)$ \\
\verb! (A.8)! & $ A \lor (B \land C) \equiv (A \lor B) \land (A \lor C)$ \\
\verb! (A.18)! & $ \neg (A \land B) \equiv \neg A \lor \neg B$ \\
\verb! (A.19)! & $ \neg (A \lor B) \equiv \neg A \land \neg B$ \\
\verb! (A.20)! & $ A \lor (\neg A \land B) \equiv A \lor B$ \\
\verb! (A.21)! & $ A \land (\neg A \lor B) \equiv A \land B$ \\
\verb! (A.22)! & $ A \Rightarrow B \equiv \neg A \lor B$ \\
\verb! (A.24)! & $ A \Rightarrow B \equiv \neg(A \land \neg B)$ \\
\verb! (A.25)! & $ \neg(A \Rightarrow B) \equiv A \land \neg B$ \\
\verb! (A.26)! & $ A \Rightarrow B \equiv \neg B \Rightarrow \neg A$ \\
\verb! (A.33)! & $ C \imp (A \land B) \equiv (C \imp A) \land (C \imp B)$ \\
\verb! (A.34)! & $ (A \lor B) \imp C \equiv (A \imp C) \land (B \imp C)$ \\
\verb! (A.35)! & $ C \imp (A \lor B) \equiv (C \imp A) \lor (C \imp B)$ \\
\verb! (A.36)! & $ (A \land B) \imp C \equiv (A \imp C) \lor (B \imp C)$ \\
\verb! (A.37)! & $ A \imp (B \imp C) \equiv (A \land B) \imp C \equiv B \imp (A \imp C)$ \\
\verb! (A.38)! & $ (A \imp B) \land (\neg A \imp C) \equiv (A \land B) \lor (\neg A \land C)$ \\
\verb! (A.56)! & $ (\forall x \text{ s.t. } x = E \imp A) \equiv A[x \backslash E] \equiv (\exists x \text{ s.t. } x = E \land A)$ \\
\end{tabular}
